...
class XmlGenerator extends \TQ\TqSeo\Sitemap\Generator\AbstractGenerator {
    ...
    public function sitemapIndex() {
        ...
        for($i=0; $i < $pageCount; $i++) {
            if( $this->indexPathTemplate ) {
                ...
                $sitemaps[] = \TQ\TqSeo\Utility\GeneralUtility::fullUrl( $TSFE->cObj->typoLink_URL($linkConf) );
            }
        }
    ...
    protected function createSitemapPage() {
        ...
        $pagePriorityDefaultValue		= (float)\TQ\TqSeo\Utility\GeneralUtility::getRootSettingValue('sitemap_priorty', 0);
        $pagePriorityDepthMultiplier	= (float)\TQ\TqSeo\Utility\GeneralUtility::getRootSettingValue('sitemap_priorty_depth_multiplier', 0);
        $pagePriorityDepthModificator	= (float)\TQ\TqSeo\Utility\GeneralUtility::getRootSettingValue('sitemap_priorty_depth_modificator', 0);
